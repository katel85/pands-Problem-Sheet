...
def sqrt(n): # here we are calling the function newton and passing in the argument (x)
...
def main():
   while True:
       ...
       n = float(n)
       n1 =round(sqrt(n),1)
       print ("This program's estimate of the square root of {} is approx {}".format(n,n1))
